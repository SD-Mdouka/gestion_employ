                                ...
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-center align-items-center">
                                        ...
                                        <form id="{{ $employe->registration_number }}"
                                            action="{{ route('employes.destroy', $employe->registration_number) }}"
                                            method="post">
                                            @csrf
                                            @method("DELETE")
                                        </form>
                                        <button onclick="deleteAd({{ $employe->registration_number }})" type="submit"
                                            title="Delete Employes" class="btn btn-sm btn-danger">
