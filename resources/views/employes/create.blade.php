        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card my-5">
                    ...
                    <div class="card-body">
                        <form method="POST" class="mt-3" action="{{ route('employes.store') }}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ old('depart') }}" name="depart"
                                    placeholder="Departement">
                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label fw-bold" for="hire_date">Hiring
                                    Date</label>
                                <input type="date" class="form-control" value="{{ old('hire_date') }}"
                                    placeholder="Hiring Date" name="hire_date">
                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label fw-bold" for="phone">Phone</label>
                                <input type="text" class="form-control" value="{{ old('phone') }}" placeholder="Phone"
                                    name="phone">
                            </div>
                            <div class="form-group mb-3">
